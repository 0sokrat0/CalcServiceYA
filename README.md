...
Этот проект представляет распределённый вычислитель арифметических выражений. Система разделена на три основные части:
...
- [🚀 Распределённый вычислитель арифметических выражений](#-распределённый-вычислитель-арифметических-выражений)
  ...
  - [🖥️ Функционал проекта](#️-функционал-проекта)
    ...
    - [2. Агент (Agent) (gRPC)](#2-агент-agent-grpc)
    - [3. Аuth (gRPC)](#3-аuth-grpc)
